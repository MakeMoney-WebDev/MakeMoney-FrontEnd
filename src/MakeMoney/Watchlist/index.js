...
function Watchlist() {
	...
	const fetchWatchlists = async () => {
		try {
			if (account) {
				setPublicWatchlist(await client.findWatchlistById(account.publicWatchlist));
				setPrivateWatchlist(await client.findWatchlistById(account.privateWatchlist));
			} else {
	...
	return (
		<div className="content">
			<div className="container-fluid">
				...
				<div className="row">
					{!account && (
						<div>Please go to account page and sign in or sign up to view your watchlist!</div>
					)}
